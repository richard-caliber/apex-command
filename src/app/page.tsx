            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={data.revenueHistory}>
                ...
                <Tooltip
                  ...
                  labelFormatter={(v) => new Date(String(v)).toLocaleDateString("en-GB", { day: "2-digit", month: "short", year: "numeric" })}
                  formatter={(v) => [`£${v}`, "MRR"]}
                />
                <Area type="monotone" dataKey="total" stroke="#06b6d4" fill="url(#grad)" strokeWidth={2} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
