#!/usr/bin/env node
// M3.5 patch — refresh ginge.current_task in apex:squad:v4.
// The pre-Magnificent string ("Building the machine that builds the
// machine") is stale; replace with the current sprint marker so the
// briefing reflects what Ginge is actually doing right now.
...
const NEW_TASK = "Magnificent sprint in progress";
